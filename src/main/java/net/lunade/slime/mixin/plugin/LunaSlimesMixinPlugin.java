package net.lunade.slime.mixin.plugin;
...
public class LunaSlimesMixinPlugin implements IMixinConfigPlugin {
    private static final String MIXIN_PATH = "net.lunade.slime.mixin.";
