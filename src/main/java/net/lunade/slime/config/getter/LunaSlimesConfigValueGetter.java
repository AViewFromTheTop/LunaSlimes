...
public class LunaSlimesConfigValueGetter {
	...
	public static boolean useSplitting() {
		if (LunaSlimesConstants.HAS_FROZENLIB) return LunaSlimesGameplayFrozenConfig.get().useSplitting;
